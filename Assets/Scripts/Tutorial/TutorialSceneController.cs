...
public class TutorialSceneController : MonoBehaviour
{
    ...
    void EnsureTutorialCanvas()
    {
        ...
        // 튜토리얼 프롬프트는 항상 최상단에 떠야 한다는 요구사항에 따라, RunHudUI 캔버스(80)와
        // InventoryUI 캔버스(500)보다 확실히 높게 둔다. (예전엔 반대로 78로 낮춰서 지도/인벤토리
        // 패널이 프롬프트보다 위에 오도록 했었으나, 이제는 프롬프트가 항상 위에 있어야 한다.)
